    ...
    <section id="team" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h4 className="text-primary font-bold uppercase tracking-widest text-sm mb-4">Our Leadership</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {TEAM.map((member, idx) => (
            <div key={idx} className="group">
              ...
              <p className="text-primary font-semibold mb-4 uppercase tracking-widest text-xs">{member.role}</p>
              <div className="flex space-x-4">
                {['linkedin', 'twitter'].map((s) => (
                  <a key={s} href="#" className="text-slate-400 hover:text-primary transition-colors">
