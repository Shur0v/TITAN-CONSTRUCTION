      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-10 -right-10 hidden md:block bg-primary text-white p-8 rounded-lg shadow-xl max-w-xs">
          ...
          <div>
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <li key={idx} className="flex items-start">
                  <span className="flex-shrink-0 w-6 h-6 bg-secondary/20 text-primary rounded-full flex items-center justify-center mr-3 mt-0.5">
            ...
            <a href="#services" className="inline-flex items-center text-primary font-bold hover:text-slate-900 transition-colors">
