    ...
    <section id="services" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h4 className="text-blue-700 font-bold uppercase tracking-widest text-sm mb-4">Our Expertise</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service) => (
            ...
            >
              <div className="text-4xl mb-6 bg-blue-50 w-16 h-16 flex items-center justify-center rounded-lg group-hover:bg-blue-700 group-hover:text-white transition-colors">
                {service.icon}
              </div>
              ...
              <a href="#contact" className="text-sm font-bold text-blue-700 hover:text-blue-900 uppercase tracking-wider flex items-center">
                Get Details
